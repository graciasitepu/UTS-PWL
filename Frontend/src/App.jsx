...
function App() {
  ...
  const fetchProducts = async () => { // mengambim data produk dari backend
    setLoading(true)
  ...
  const handleClose = () => { // menutup modal tombol tambah atau edit product
    setShowAddProduct(false)
    setShowEditProduct(false)
  }

  // untuk update data produk setelah create atau edit
  const onCreate = () => {
    fetchProducts()
    handleClose()
  }
