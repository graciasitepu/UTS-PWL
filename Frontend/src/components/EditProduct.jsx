...
const EditProduct = ({ show, handleClose, onUpdate, data }) => {
   ...
   const handleInputChange = (event) => { // kelola perubahan input
   ...
   const handleSubmit = async (event) => { // submit perubahan edit product
   ...
   return ( // menampilkan tombol edit product dan popup inputan data perubahan
      <div>
